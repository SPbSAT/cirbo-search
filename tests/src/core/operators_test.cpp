...
TEST_CASE("Operators MUX_F", "[operators][mux]")
{
    ...
    REQUIRE(cirbo::op::MUX(logic, cirbo::GateState::UNDEFINED, cirbo::GateState::UNDEFINED) == cirbo::GateState::UNDEFINED);
}
...
TEST_CASE("Operators CONST_TRUE", "[operators][const]")
{
    REQUIRE(cirbo::op::CONST_TRUE() == cirbo::GateState::TRUE);
}
