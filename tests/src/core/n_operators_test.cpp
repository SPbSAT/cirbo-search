...
)
{
    ...
    [[maybe_unused]] cirbo::GateState la =
        oper2(oper2(fst, snd, cirbo::GateState::UNDEFINED), trd, cirbo::GateState::UNDEFINED);
    [[maybe_unused]] cirbo::GateState ra =
        operN(cirbo::GateStateContainer{fst, snd, trd});
...
TEST_CASE("OperatorsN AND", "[operatorsN]")
{
    ...
    {
        LOG_TRIPLET("AND", arg);
        assertAssociativeBinaryOperatorTripleN(
            cirbo::GateType::AND,
            arg.at(0), arg.at(1), arg.at(2)
        );
    }
}
...
TEST_CASE("OperatorsN NOR", "[operatorsN]")
{
    for (auto const& arg : getAllNplets(3))
    {
        ...
        cirbo::log::getGlobalLogger().info(
            "Answer is ",
            cirbo::utils::gateStateToString(
                cirbo::op::OR({arg.at(0), arg.at(1), arg.at(2)})
            )
        );
        cirbo::log::getGlobalLogger().info(
            "Expected ",
...
TEST_CASE("OperatorsN MUX_F", "[operatorsN][mux]")
{
    for (auto first_op : {cirbo::GateState::FALSE, cirbo::GateState::TRUE, cirbo::GateState::UNDEFINED})
        for (auto second_op : {cirbo::GateState::FALSE, cirbo::GateState::TRUE, cirbo::GateState::UNDEFINED})
            REQUIRE(
                cirbo::op::MUX({cirbo::GateState::FALSE, first_op, second_op}) ==
                first_op
            );
}
...
TEST_CASE("OperatorsN MUX_T", "[operatorsN][mux]")
{
    for (auto first_op : {cirbo::GateState::FALSE, cirbo::GateState::TRUE, cirbo::GateState::UNDEFINED})
        for (auto second_op : {cirbo::GateState::FALSE, cirbo::GateState::TRUE, cirbo::GateState::UNDEFINED})
            REQUIRE(
                cirbo::op::MUX({cirbo::GateState::TRUE, first_op, second_op}) ==
                second_op
            );
}
...
TEST_CASE("OperatorsN MUX_U", "[operatorsN][mux]")
{
    for (auto first_op : {cirbo::GateState::FALSE, cirbo::GateState::TRUE, cirbo::GateState::UNDEFINED})
        for (auto second_op : {cirbo::GateState::FALSE, cirbo::GateState::TRUE, cirbo::GateState::UNDEFINED})
            REQUIRE(
                cirbo::op::MUX({cirbo::GateState::UNDEFINED, first_op, second_op}) ==
                cirbo::GateState::UNDEFINED
            );
}
...
{
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::NOT) ==
            (cirbo::op::OperatorN)&cirbo::op::NOT);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::AND) ==
            (cirbo::op::OperatorN)&cirbo::op::AND);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::NAND) ==
            (cirbo::op::OperatorN)&cirbo::op::NAND);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::OR) ==
            (cirbo::op::OperatorN)&cirbo::op::OR);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::NOR) ==
            (cirbo::op::OperatorN)&cirbo::op::NOR);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::XOR) ==
            (cirbo::op::OperatorN)&cirbo::op::XOR);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::NXOR) ==
            (cirbo::op::OperatorN)&cirbo::op::NXOR);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::MUX) ==
            (cirbo::op::OperatorN)&cirbo::op::MUX);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::IFF) ==
            (cirbo::op::OperatorN)&cirbo::op::IFF);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::CONST_FALSE) ==
            (cirbo::op::OperatorN)&cirbo::op::CONST_FALSE);
    REQUIRE(cirbo::op::getOperatorN(cirbo::GateType::CONST_TRUE) ==
            (cirbo::op::OperatorN)&cirbo::op::CONST_TRUE);
}
